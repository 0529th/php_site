...
<body>
    ...
    <main id="contents">
        ...
        <section id="card-type" class="section center">
            <div class="container">
                <h3 class="section__title">수강한 강의</h3>
                <p class="section__desc">
                    Node.js, MySQL, PHP에대한 지식을 새롭게 쌓아나가고 있습니다.
                </p>
        ...
        <section id="comment-type" class="section center purple">
            <h3 class="section__title">댓글 달기</h3>
            <p class="section__desc">회원가입 하지 않아도 댓글을 남길 수 있습니다. 100글자 이내로 써주세요!</p>
...
<?php
    ...
    $sql = "SELECT * FROM myComment ORDER BY regTime DESC LIMIT 20";
